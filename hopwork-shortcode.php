...
function hopwork_shortcode_widget($atts){
    ...
    extract($atts);
    return '<a class="hopwork_widget" href="https://www.malt.com/profile/" '.$profil.' " data-id=" '.$dataid.' " data-picture="'.$picture.'" data-tags="'.$tags.'" data-recos="'.$recos.'" data-height="'.$height.'" data-style="'.$style.'" data-width=" '.$width.'">Voir mon profil freelance</a>';
...
function hopwork_shortcode_button($atts){
    ...
    extract($atts);
    return '<a href="https://www.malt.com/profile/"'.$profil.'" data-id="'.$dataid.'" class="hopwork_button" data-width="'.$datawidth.'" data-layout="'.$datalayout.'" data-recos="'.$datarecos.'" data-bgrecos="clear" data-colorscheme="'.$datacolor.'">Mon Profil Malt!</a>';   
}
